      ...
      <div className="about-container">
        <div className="about-card">
          ...
          <div className="about-content">
            <h3 className="about-header">DOĞAL — наше видение и ценности</h3>
            <p className="about-text">
              Компания <strong>DOĞAL</strong> стремится стать ведущим партнёром в сельском хозяйстве стран СНГ, предоставляя качественные агрохимикаты и пестициды для устойчивого увеличения урожайности. <br />
              ...
              Продукция <strong>DOĞAL</strong> не только защищает растения, но и способствует развитию экологически безопасных методов ведения сельского хозяйства в Кыргызстане, Казахстане, Узбекистане и России.
            </p>
          </div>
        </div>
      </div>
