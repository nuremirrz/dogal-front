...
const ProductCard = ({ product, onDetailClick }) => {
  return (
    <div className="flex borber border-customGreen-400 justify-between items-start p-4 bg-white shadow-md rounded-xl mb-4 max-[768px]:flex-wrap transition-transform transform hover:scale-105 hover:shadow-lg">
